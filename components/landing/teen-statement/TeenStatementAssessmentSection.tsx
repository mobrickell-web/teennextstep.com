...
import {
  ...
  TEEN_STATEMENT_DASHBOARD_IMAGE,
} from "@/components/landing/teen-statement/content/assessment-section";
...
export default function TeenStatementAssessmentSection() {
  ...
  return (
    <section
      id="teen-statement-assessment"
      aria-labelledby="teen-statement-assessment-heading"
        ...
        <div className={cn(assessmentSectionWidthClass, "space-y-10 sm:space-y-12")}>
          <div className="space-y-3 text-center sm:space-y-4">
            {header.notes.map((note, index) => (
              <Typography
                key={note}
                id={index === 0 ? "teen-statement-assessment-heading" : undefined}
                variant="body-regular"
                as="p"
                className="mx-auto w-full text-sm font-medium leading-relaxed text-foreground sm:text-base"
              >
                {note}
              </Typography>
            ))}
      ...
      <div className="border-t border-[#e8e8e8] bg-white">
        <div className="w-full px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-14 xl:px-10">
          ...
          >
            <div className="space-y-6">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <Button
                  type="submit"
                  size="cta"
                  className="h-[52px] w-full rounded-lg text-base font-semibold text-white"
                >
            ...
            <div className="relative min-h-[220px] w-full min-w-0 overflow-hidden rounded-[9px] border border-[#d8d8d8] sm:min-h-[260px] lg:h-full lg:min-h-0">
              <Image
